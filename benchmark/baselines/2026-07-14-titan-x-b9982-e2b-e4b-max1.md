...
Run `b9982-6704fa51fe` used source `caa927332af42b611aaf2444bab2d47129d29934` with `ghcr.io/ggml-org/llama.cpp:server-cuda-b9982` (version: 9982 (99f3dc322)) on preset `12gb.ini` and `models-max=1`.

Started: `2026-07-14T04:00:03.352Z`; duration: `199.057s`; contract: `1.0.0`; evaluation corpus: `1.0.0`; hardware tier: `12gb`.
...
- Cell status counts: `{"passed": 13, "skipped": 5}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | ---: | --- | --- | --- |
| `cold-readiness` | passed | `—` | 1858.6 | — | — | — | — / — | — | pass | — | — |
| `models-discovery` | passed | `—` | — | — | — | — | — / — | — | pass | — | — |
| `configured-identity-route-a` | passed | `unsloth/gemma-4-E2B-it-qat-GGUF:UD-Q4_K_XL` | 22.2 | — | — | — | — / — | — | pass | — | — |
| `first-load-a-router-id` | passed | `unsloth/gemma-4-E2B-it-qat-GGUF:Q4_K_XL` | 53633.5 | — | 11350.6 | 68.3 | 17 / 5 | 5189 | pass | — | — |
| `warm-a` | passed | `gemma-4-e2b` | 253.5 | — | 56.8 | 49.4 | 15 / 4 | 5189 | pass | — | — |
| `stream-a` | passed | `gemma-4-e2b` | 370.2 | 192.8 | — | — | — / — | 5189 | pass | — | — |
| `stream-cancel-a` | passed | `gemma-4-e2b` | 221.0 | — | — | — | — / — | — | pass | — | — |
| `concurrency-2-a` | passed | `gemma-4-e2b` | 648.7 | — | — | — | — / — | 5189 | pass | — | — |
| `structured-aurora-facts-v1` | passed | `gemma-4-e2b` | 1399.2 | — | 150.5 | 1112.7 | 96 / 88 | 5197 | pass | pass | none |
| `structured-cedar-plan-v1` | passed | `gemma-4-e2b` | 4725.4 | — | 122.7 | 4452.8 | 158 / 248 | 5201 | pass | pass | none |
| `tools-a` | skipped (operator_disabled) | `gemma-4-e2b` | — | — | — | — | — / — | — | — | — | — |
| `swap-a-to-b` | passed | `unsloth/gemma-4-E4B-it-qat-GGUF:Q4_K_XL` | 15884.0 | — | 151.8 | 86.8 | 17 / 5 | 7369 | pass | — | — |
| `swap-b-to-a` | passed | `gemma-4-e2b` | 14069.0 | — | 123.5 | 59.9 | 18 / 6 | 7369 | pass | — | — |
...
- `structured_skip` / `operator_disabled`: Tool envelope replay was disabled for this run. Cells: `tools-a`.
...
```text
python -m prefer_bench local --lane b9982 --cache-source-volume prefer-model-cache --models gemma-4-e2b,gemma-4-e4b --preset 12gb.ini --models-max 1 --contexts none --skip-tools --timeout-seconds 300 --readiness-timeout-seconds 120 --no-build --output benchmark/artifacts/2026-07-14-b9982-e2b-e4b-max1.json
```
