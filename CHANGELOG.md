...
- Release tooling
  ...
  - Fixed npm publication to publish the release-local package tarball and use a warning-free temporary registry credential file.
- Models
...
- Llama
  - `qwen-3.8-27b`
    ...
    - Kept the Q6 target, MTP, context, concurrency, cache, and sampling settings unchanged.
- SGLang video
